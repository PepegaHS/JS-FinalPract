// Категории новостей (Демократы, Республикацы, Посередине)
...
// Профили пользователей (User A и User B)
const users = {
    'user-a': {
        name: 'Пользователь А',
        interests: {
...
function loadStateFromLocalStorage() {
    // Инициализация постов в localStorage
    ...
    // Загрузка других параметров симуляции
